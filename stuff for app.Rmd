...
#      constraints <-append(constraints, "convexity")
    ...
    funcs<- simulate_constrained_gp(x_orig, y, kernel_label, kernel_params, constraints, constraint_params, 5)
    #cat(paste("\n\n","funcs in pool", funcs, "\n\n"))
    ...
    data <- data.frame(
      x = rep(x_orig, length(idx)),
      f = as.vector(funcs),
      func = rep(idx, each = length(x_orig))
    )    
