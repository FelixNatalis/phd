...
model {
  ...
  length_scale_k1_s2 ~ inv_gamma(2, 14); // just one jump in the area [-24;24]
  ...
  steepness1         ~ gamma(5, 0.5);    // prior centred around higher steepness
  steepness2         ~ gamma(3, 0.5);    // prior centred around lower steepness
  // Individual GP priors
  length_scale_k2_s1 ~ inv_gamma(3, 7);
  length_scale_k2_s2 ~ inv_gamma(2, 11);
  length_scale_k2_s3 ~ inv_gamma(3, 7);
