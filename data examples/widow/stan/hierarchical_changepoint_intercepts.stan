...
model {
  ...
  // Shared GP priors
  length_scale_k1_s1 ~ inv_gamma(5, 5);
  length_scale_k1_s2 ~ inv_gamma(5, 5);
  length_scale_k1_s3 ~ inv_gamma(5, 5);
  variance_k1_s1     ~ inv_gamma(5, 5);
  variance_k1_s2     ~ inv_gamma(3, 3);  // higher variance for central section
  variance_k1_s3     ~ inv_gamma(5, 5);
  steepness1         ~ gamma(4, 0.5);    // prior centred around higher steepness
  steepness2         ~ gamma(2, 0.5);    // prior centred around lower steepness

  // Individual GP priors
  length_scale_k2_s1 ~ inv_gamma(5, 5);
  length_scale_k2_s2 ~ inv_gamma(5, 5);
  length_scale_k2_s3 ~ inv_gamma(5, 5);
  variance_k2_s1     ~ inv_gamma(5, 5);
  variance_k2_s2     ~ inv_gamma(3, 3);
  variance_k2_s3     ~ inv_gamma(5, 5);
